...
{
    [TestFixture]
    public class RegistraciajPostojeEgKorisnika
    {
        ...
        [Test]
        public void TheRegistraciajPostojeEgKorisnikaTest()
        {
            ...
            driver.FindElement(By.Name("email")).SendKeys("perica.peric123@gmail.com");
            driver.FindElement(By.Name("firstname")).Click();
            driver.FindElement(By.Name("firstname")).Clear();
            driver.FindElement(By.Name("firstname")).SendKeys("Perica");
